...
public class PlayerESP extends BaseModule implements QuickImports {
    ...
    private void Render3DEvent(Render3DEvent event) {
        if (event.getMode().equals(com.tsorf.impl.events.render.Render3DEvent.Mode.PRE)) {
            hashMap.clear();
    ...
    private void Render2DEvent(com.tsorf.impl.events.render.Render2DEvent event) {
        if (event.getMode().equals(com.tsorf.impl.events.render.Render2DEvent.Mode.PRE) && espMode.getValue().equals("Outlined 2D")) {
