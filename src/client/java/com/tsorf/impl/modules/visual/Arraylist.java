...
public class Arraylist extends BaseModule implements QuickImports {
    ...
    public FontAtlas getFont() {
        return switch (font.getValue()) {
            case "Inter Semi-Bold" -> Tsorf.getInstance().getFonts().getInterSemiBold();
            case "Inter Bold" -> Tsorf.getInstance().getFonts().getInterBold();
            case "Inter Medium" -> Tsorf.getInstance().getFonts().getInterMedium();
            case "Proggy Clean" -> Tsorf.getInstance().getFonts().getProggyClean();
            case "Poppins" -> Tsorf.getInstance().getFonts().getPoppins();
