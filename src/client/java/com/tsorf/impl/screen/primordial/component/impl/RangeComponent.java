...
public class RangeComponent extends Component {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        float valueWidth = Tsorf.getInstance().getFonts().getInterMedium().getWidth(value, 6);
        Tsorf.getInstance().getFonts().getInterMedium().render(context.getMatrices(), value, getX() + getWidth() - 5 - valueWidth, getY() + 2.5f, 6, 0xFF909090);
