package com.tsorf.impl.screen.tsorf;

import tsorf0.Tsorf;
import com.tsorf.api.module.Module;
import com.tsorf.api.module.ModuleCategory;
import com.tsorf.api.module.setting.Setting;
import com.tsorf.api.module.setting.implement.*;
...
public class TsorfScreen extends Screen implements QuickImports {
    @Getter
    private static final TsorfScreen INSTANCE = new TsorfScreen();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontAtlas inter = Tsorf.getInstance().getFonts().getInterSemiBold();
        FontAtlas icons = Tsorf.getInstance().getFonts().getLucide();
