...
public class ConcreteClientInfoProvider implements ClientInfoProvider {
    ...
    public Path clientDir() {
        return Path.of(System.getProperty("user.home"), ".tsorf");
    }

    @Override
    public Path configsDir() {
        return Path.of(System.getProperty("user.home"), ".tsorf", "configs");
    }

    @Override
    public Path filesDir() {
        return Path.of(System.getProperty("user.home"), ".tsorf", "files");
    }
