package com.tsorf.common.util.math.rotation;
...
import com.tsorf.impl.modules.combat.Piercing;
...
public class RotationUtils implements QuickImports {
    ...
    public static BlockHitResult rayTrace(float yaw, float pitch, float reach, float tickDelta) {
        ...
        return mc.world.raycast(new RaycastContext(start, end, Tsorf.getInstance().getModuleManager().getModule(Piercing.class).isEnabled() ? RaycastContext.ShapeType.COLLIDER : RaycastContext.ShapeType.OUTLINE, RaycastContext.FluidHandling.NONE, mc.cameraEntity));
    }
