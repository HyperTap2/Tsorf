package com.tsorf.api.system.render.font;

import cc.polymorphism.annot.ExcludeFlow;
import com.tsorf.api.system.render.Shaders;
...
public class FontAtlas {
    ...
    public FontAtlas(final ResourceManager manager, final String name) throws IOException {
        this(
                new InputStreamReader(manager.open(Identifier.of("tsorf", "fonts/" + name + ".json"))),
                manager.open(Identifier.of("tsorf", "fonts/" + name + ".png"))
        );
    }
