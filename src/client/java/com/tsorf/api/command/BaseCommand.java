 ...
 * Created: 2/3/2025
 */
package com.tsorf.api.command;

import tsorf0.Tsorf;
import com.tsorf.api.command.exception.CommandException;
...
public abstract class BaseCommand implements QuickImports {
    ...
    public String toString() {
        return Tsorf.getInstance().getCommandManager().getPrefix() + commandInfo.name();
    }
